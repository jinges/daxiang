...
$(function(){
	...
	$("#btn_orderView").click(function(){
		...
		params.money = $("#yuan").val().replace(/\D/g, '');
...
function viewOrder(){
	...
	params.yuan = duihuan(params.buy, params.sum.replace(',', ''), (params.rate/ 100).toFixed(4)) + params.change;
				...
				if(type == 'update'){
					postData('updatePhone', JSON.stringify({'phone': phone}),
						function(err){
							...
							window.location = 'updatephonesuccess.html';
						}
					)
				} else {
					postData('addChannel', JSON.stringify({'phone': phone, 'name': name}),
						function(err){
							...
							window.location = 'registsuccess.html';
						}
					)
				}
			}
